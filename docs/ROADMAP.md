...
| M4 - stamina/fitness loop | A playtested exertion/recovery loop; no medical or calorie accuracy claims. |
| M5 - simple food/prey | One small food-seeking interaction and reward loop. |
| M6 - other birds/predators | Minimal behavior in the existing test space. |
